...
impl JType for Arc<Box<NullityInterface>> {
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self {
        let proxy_class = get_class(jni_env, "com/dropbox/djinni/test/NullityInterface$CppProxy");
        ...
        if is_proxy {
            ...
            *Self::from_handle(handle)
            ...
            Arc::new(Box::new(NullityInterfaceJavaProxy { java_ref: GlobalRef::new(jni_env, j) }))
        }
    }

    fn from_rust(jni_env: *mut JNIEnv, r: Self) -> Self::JniType {
        if let Some(proxy) = r.downcast_ref::<NullityInterfaceJavaProxy>() {
            return proxy.java_ref.get();
        }
        // Is not a Java proxy, need to create a new CppProxy
        // TODO(rustgen) - cache the CppProxys
        let class = ::support_lib::support::get_class(jni_env, "com/dropbox/djinni/test/NullityInterface$CppProxy");
...
impl RustProxyable for Arc<Box<NullityInterface>> {
...
impl NullityInterface for NullityInterfaceJavaProxy {
    fn non_null_parameters(&self, r_p1: Arc<Box<DummyInterface>>, r_p2: Arc<Box<DummyInterface>>) {
        ...
        let class = get_class(jni_env, "com/dropbox/djinni/test/NullityInterface");
        let jmethod = get_method(jni_env, class, "nonNullParameters", "(Lcom/dropbox/djinni/test/DummyInterface;Lcom/dropbox/djinni/test/DummyInterface;)V");
        // TODO(rustgen): handle local refs correctly
        jni_invoke!(jni_env, CallVoidMethod, self.java_ref.get(), jmethod,
                    Arc::<Box<DummyInterface>>::from_rust(jni_env, r_p1).for_variadic(),
                    Arc::<Box<DummyInterface>>::from_rust(jni_env, r_p2).for_variadic());
    }
    fn non_null_return(&self, r_should_return_null: bool) -> Arc<Box<DummyInterface>> {
        ...
        // TODO(rustgen): use helper to cache class object and method IDs
        let class = get_class(jni_env, "com/dropbox/djinni/test/NullityInterface");
        let jmethod = get_method(jni_env, class, "nonNullReturn", "(Z)Lcom/dropbox/djinni/test/DummyInterface;");
        // TODO(rustgen): handle local refs correctly
        let jret = jni_invoke!(jni_env, CallObjectMethod, self.java_ref.get(), jmethod,
                    bool::from_rust(jni_env, r_should_return_null).for_variadic());
    ...
    fn nullable_parameters(&self, r_p1: Option<Arc<Box<DummyInterface>>>, r_p2: Option<Arc<Box<DummyInterface>>>) {
        ...
        // TODO(rustgen): use helper to cache class object and method IDs
        let class = get_class(jni_env, "com/dropbox/djinni/test/NullityInterface");
        let jmethod = get_method(jni_env, class, "nullableParameters", "(Lcom/dropbox/djinni/test/DummyInterface;Lcom/dropbox/djinni/test/DummyInterface;)V");
        // TODO(rustgen): handle local refs correctly
        jni_invoke!(jni_env, CallVoidMethod, self.java_ref.get(), jmethod,
                    Option::<Arc<Box<DummyInterface>>>::from_rust(jni_env, r_p1).for_variadic(),
                    Option::<Arc<Box<DummyInterface>>>::from_rust(jni_env, r_p2).for_variadic());
    }
    fn nullable_return(&self, r_should_return_null: bool) -> Option<Arc<Box<DummyInterface>>> {
        ...
        // TODO(rustgen): use helper to cache class object and method IDs
        let class = get_class(jni_env, "com/dropbox/djinni/test/NullityInterface");
        let jmethod = get_method(jni_env, class, "nullableReturn", "(Z)Lcom/dropbox/djinni/test/DummyInterface;");
        // TODO(rustgen): handle local refs correctly
        let jret = jni_invoke!(jni_env, CallObjectMethod, self.java_ref.get(), jmethod,
                    bool::from_rust(jni_env, r_should_return_null).for_variadic());
...
struct NullityInterfaceCppProxy {
    rust_ref: Arc<Box<NullityInterface>>
}

#[no_mangle]
#[inline(never)]
#[allow(non_snake_case)]
pub extern "C" fn Java_com_dropbox_djinni_test_NullityInterface_00024CppProxy_nativeDestroy(jni_env: *mut JNIEnv, _this: jobject, native_ref: jlong) {
    let _to_delete: Box<Arc<Box<NullityInterface>>> = Arc::<Box<NullityInterface>>::from_handle(native_ref);
...
#[inline(never)]
#[allow(non_snake_case)]
pub extern "C" fn Java_com_dropbox_djinni_test_NullityInterface_00024CppProxy_native_1nonNullParameters(jni_env: *mut JNIEnv, _this: jobject, native_ref: jlong, j_p1: jobject, j_p2: jobject) {
...
#[inline(never)]
#[allow(non_snake_case)]
pub extern "C" fn Java_com_dropbox_djinni_test_NullityInterface_00024CppProxy_native_1nullableParameters(jni_env: *mut JNIEnv, _this: jobject, native_ref: jlong, j_p1: jobject, j_p2: jobject) {
    let rust_ref: Box<Arc<Box<NullityInterface>>> = Arc::<Box<NullityInterface>>::from_handle(native_ref);
