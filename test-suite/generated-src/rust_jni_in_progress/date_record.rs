...
use generated_rust::date_record::DateRecord;

pub struct NativeDateRecord;
impl JType for NativeDateRecord
{
    type RustType = DateRecord;
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self::RustType {
        ...
        let field_created_at = support_lib::support::get_method(jni_env, class, "mCreatedAt", "Ljava/util/Date;");
