...
impl JType for Arc<Box<StaticNullityInterface>> {
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self {
        ::std::sync::Arc::new(::std::boxed::Box::new(StaticNullityInterfaceJavaProxy { javaRef: j }))
    }
...
#[inline(never)]
#[allow(non_snake_case)]
pub extern "C" fn Java_com_dropbox_djinni_test_StaticNullityInterface_00024CppProxy_nativeDestroy(jni_env: *mut JNIEnv, _this: jobject, nativeRef: jlong) {
