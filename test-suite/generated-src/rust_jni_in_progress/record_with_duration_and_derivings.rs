...
impl JType for NativeRecordWithDurationAndDerivings
{
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self::RustType {
        ...
        let field_dt = support_lib::support::get_method(jni_env, class, "mDt", "Ljava/time/Duration;");

        assert!(j != 0 as jobject);
        RecordWithDurationAndDerivings {
            // would grab field_dt, but MExtern not implemented
        }
    }
    ...
    fn from_rust(jni_env: *mut JNIEnv, r: Self::RustType) -> Self::JniType {
        ...
        jni_invoke!(jni_env, NewLocalRef, jni_invoke!(jni_env, NewObject, class, jconstructor,
                                                      // would grab dt, but MExtern not implemented))
    }
