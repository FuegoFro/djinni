...
use support_lib::jni_ffi::jdouble;
use support_lib::support::get_field;
use support_lib::jni_ffi::jshort;
...
use support_lib::jni_ffi::jbyte;
use support_lib::jni_ffi::jlong;
use support_lib::jni_ffi::jfloat;
...
impl JType for ::generated_rust::assorted_primitives::AssortedPrimitives {
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self {
        ...
        let class = get_class(jni_env, "com/dropbox/djinni/test/AssortedPrimitives");
        let field_b = get_field(jni_env, class, "mB", "Z");
        let field_eight = get_field(jni_env, class, "mEight", "B");
        let field_sixteen = get_field(jni_env, class, "mSixteen", "S");
        let field_thirtytwo = get_field(jni_env, class, "mThirtytwo", "I");
        let field_sixtyfour = get_field(jni_env, class, "mSixtyfour", "J");
        let field_fthirtytwo = get_field(jni_env, class, "mFthirtytwo", "F");
        let field_fsixtyfour = get_field(jni_env, class, "mFsixtyfour", "D");
        let field_o_b = get_field(jni_env, class, "mOB", "Ljava/lang/Boolean;");
        let field_o_eight = get_field(jni_env, class, "mOEight", "Ljava/lang/Byte;");
        let field_o_sixteen = get_field(jni_env, class, "mOSixteen", "Ljava/lang/Short;");
        let field_o_thirtytwo = get_field(jni_env, class, "mOThirtytwo", "Ljava/lang/Integer;");
        let field_o_sixtyfour = get_field(jni_env, class, "mOSixtyfour", "Ljava/lang/Long;");
        let field_o_fthirtytwo = get_field(jni_env, class, "mOFthirtytwo", "Ljava/lang/Float;");
        let field_o_fsixtyfour = get_field(jni_env, class, "mOFsixtyfour", "Ljava/lang/Double;");
    ...
    fn from_rust(jni_env: *mut JNIEnv, r: Self) -> Self::JniType {
        ...
        let class = get_class(jni_env, "com/dropbox/djinni/test/AssortedPrimitives");
        let jconstructor = get_method(jni_env, class, "<init>", "(ZBSIJFDLjava/lang/Boolean;Ljava/lang/Byte;Ljava/lang/Short;Ljava/lang/Integer;Ljava/lang/Long;Ljava/lang/Float;Ljava/lang/Double;)V");
