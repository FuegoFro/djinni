...
impl JType for ::generated_rust::set_record::SetRecord {
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self {
        ...
        let class = get_class(jni_env, "com/dropbox/djinni/test/SetRecord");
        let field_set = get_field(jni_env, class, "mSet", "Ljava/util/HashSet;");
        let field_iset = get_field(jni_env, class, "mIset", "Ljava/util/HashSet;");
    ...
    fn from_rust(jni_env: *mut JNIEnv, r: Self) -> Self::JniType {
        ...
        let class = get_class(jni_env, "com/dropbox/djinni/test/SetRecord");
        let jconstructor = get_method(jni_env, class, "<init>", "(Ljava/util/HashSet;Ljava/util/HashSet;)V");
