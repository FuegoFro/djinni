...
impl JType for ::generated_rust::map_list_record::MapListRecord {
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self {
        ...
        let class = get_class(jni_env, "com/dropbox/djinni/test/MapListRecord");
        let field_map_list = get_field(jni_env, class, "mMapList", "Ljava/util/ArrayList;");

        assert!(j != 0 as jobject);
        ::generated_rust::map_list_record::MapListRecord {
            map_list: Vec::<HashMap<String, i64>>::to_rust(jni_env, jni_invoke!(jni_env, GetObjectField, j, field_map_list)),
        }
    }
    ...
    fn from_rust(jni_env: *mut JNIEnv, r: Self) -> Self::JniType {
        ...
        jni_invoke!(jni_env, NewLocalRef, jni_invoke!(jni_env, NewObject, class, jconstructor,
                                                      Vec::<HashMap<String, i64>>::from_rust(jni_env, r.map_list).for_variadic()))
    }
