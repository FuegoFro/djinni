...
impl JType for NativeMapListRecord
{
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self::RustType {
        ...
        let field_mMapList = support_lib::support::get_method(jni_env, class, "mMapList", "Ljava/util/ArrayList;");

        assert!(j != 0 as jobject);
        MapListRecord {
            map_list: support_lib::support::List::<support_lib::support::Map::<support_lib::support::String, support_lib::support::I64>>::to_rust(jni_env, jni_invoke!(jni_env, GetObjectField, j, field_mMapList)),
        }
    }
