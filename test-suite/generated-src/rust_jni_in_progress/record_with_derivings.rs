...
impl JType for ::generated_rust::record_with_derivings::RecordWithDerivings {
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self {
        ...
        let class = get_class(jni_env, "com/dropbox/djinni/test/RecordWithDerivings");
        let field_key1 = get_field(jni_env, class, "mKey1", "I");
        let field_key2 = get_field(jni_env, class, "mKey2", "Ljava/lang/String;");
