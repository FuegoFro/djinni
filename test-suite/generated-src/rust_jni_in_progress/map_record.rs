...
impl JType for NativeMapRecord
{
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self::RustType {
        ...
        let field_map = support_lib::support::get_method(jni_env, class, "mMap", "Ljava/util/HashMap;");
        let field_imap = support_lib::support::get_method(jni_env, class, "mImap", "Ljava/util/HashMap;");

        assert!(j != 0 as jobject);
        MapRecord {
            map: support_lib::support::Map::<support_lib::support::String, support_lib::support::I64>::to_rust(jni_env, jni_invoke!(jni_env, GetObjectField, j, field_map)),
            imap: support_lib::support::Map::<support_lib::support::I32, support_lib::support::I32>::to_rust(jni_env, jni_invoke!(jni_env, GetObjectField, j, field_imap)),
        }
    }
    ...
    fn from_rust(jni_env: *mut JNIEnv, r: Self::RustType) -> Self::JniType {
        ...
        jni_invoke!(jni_env, NewLocalRef, jni_invoke!(jni_env, NewObject, class, jconstructor,
                                                      support_lib::support::Map::<support_lib::support::String, support_lib::support::I64>::from_rust(jni_env, r.map).for_variadic(),
                                                      support_lib::support::Map::<support_lib::support::I32, support_lib::support::I32>::from_rust(jni_env, r.imap).for_variadic()))
    }
