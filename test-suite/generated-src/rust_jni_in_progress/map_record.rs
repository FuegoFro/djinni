...
impl JType for ::generated_rust::map_record::MapRecord {
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self {
        ...
        let class = get_class(jni_env, "com/dropbox/djinni/test/MapRecord");
        let field_map = get_field(jni_env, class, "mMap", "Ljava/util/HashMap;");
        let field_imap = get_field(jni_env, class, "mImap", "Ljava/util/HashMap;");
    ...
    fn from_rust(jni_env: *mut JNIEnv, r: Self) -> Self::JniType {
        ...
        let class = get_class(jni_env, "com/dropbox/djinni/test/MapRecord");
        let jconstructor = get_method(jni_env, class, "<init>", "(Ljava/util/HashMap;Ljava/util/HashMap;)V");
