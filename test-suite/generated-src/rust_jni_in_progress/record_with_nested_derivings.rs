...
impl JType for ::generated_rust::record_with_nested_derivings::RecordWithNestedDerivings {
    ...
    fn to_rust(jni_env: *mut JNIEnv, j: Self::JniType) -> Self {
        ...
        let class = get_class(jni_env, "com/dropbox/djinni/test/RecordWithNestedDerivings");
        let field_key = get_field(jni_env, class, "mKey", "I");
        let field_rec = get_field(jni_env, class, "mRec", "Lcom/dropbox/djinni/test/RecordWithDerivings;");
    ...
    fn from_rust(jni_env: *mut JNIEnv, r: Self) -> Self::JniType {
        ...
        let class = get_class(jni_env, "com/dropbox/djinni/test/RecordWithNestedDerivings");
        let jconstructor = get_method(jni_env, class, "<init>", "(ILcom/dropbox/djinni/test/RecordWithDerivings;)V");
